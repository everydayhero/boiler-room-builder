...
`, () => {
  ...
  assert.strictEqual(join(process.cwd(), '/dist'), serverOutputPath)
  assert.strictEqual(join(process.cwd(), '/dist'), clientOutputPath)
})
...
`, () => {
  ...
  assert.strictEqual('/foobar/', serverOutputPath)
  assert.strictEqual('/foobar/', clientOutputPath)
})
...
`, () => {
  ...
  assert.strictEqual(join(process.cwd(), '/source'), serverContext)
  assert.strictEqual(join(process.cwd(), '/source'), clientContext)
})
...
`, () => {
  ...
  assert.strictEqual('/foobaz/', serverContext)
  assert.strictEqual('/foobaz/', clientContext)
})
...
`, () => {
  ...
  assert.strictEqual('/foobaz/', serverPublicPath)
  assert.strictEqual('/foobaz/', clientPublicPath)
})
...
`, () => {
  ...
  assert.strictEqual('/foobar/', serverContext)
  assert.strictEqual('/foobar/', clientContext)
})
